...
| :----: | :--------: | :---------------------------------------------------: | :----------------------------------------------------: | :----------------------------------------------------: |
| `1.0`  | 01/06/2025 | Adicionando estrutura do diagrama de classes, ajudei na corração do diagrama UML e na criação dos demais códigos |[Letícia Resende da Silva](https://github.com/LeticiaResende23)  |  [Leandro de Almeida Oliveira](https://github.com/leomitx10)  |
| `1.1`  | 01/06/2025 | Ajudei na corração do diagrama UML e na criação dos demais códigos |[Leandro de Almeida Oliveira](https://github.com/leomitx10)  | [Letícia Resende da Silva](https://github.com/LeticiaResende23)  |
| `1.2`  | 01/06/2025 | Ajudei na corração do diagrama UML e na criação dos demais códigos | [Vinicius Castelo](https://github.com/Vini47)  | [Letícia Resende da Silva](https://github.com/LeticiaResende23)  |
| `1.3`  | 01/06/2025 | Ajudei na corração do diagrama UML e na criação dos demais códigos | [Matheus Barros do Nascimento](https://github.com/Ninja-Haiyai)  | [Letícia Resende da Silva](https://github.com/LeticiaResende23)  |